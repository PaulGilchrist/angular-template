...
export class D3GraphComponent implements OnInit, OnChanges {
	...
	ngOnInit(): void {
		...
		d3Utils.draw(this.type, this.el.nativeElement, this.tooltip, this.data, this.width, this.height, this.xType, this.xKey, this.yKey, this.xToFixed, this.yToFixed, this.labels, this.warningLevel);
	}
