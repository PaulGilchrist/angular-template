...
describe('IdentityService', function () {
    beforeEach(function () {
        testing_1.TestBed.configureTestingModule({ declarations: [identity_service_1.IdentityService] });
    });
    it('Successfully decrypted token and accessed Audience ID', testing_1.inject([identity_service_1.IdentityService], function (service) {
        ...
        var token = service.extractToken(jwtToken);
