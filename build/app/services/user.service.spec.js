...
describe('UserService', function () {
    ...
    it('Successfully pulled addresses for a given user from remote API', testing_1.inject([user_service_1.UserService], function (service) {
        service.getUserAddresses(users[0]).subscribe(function (addresses) {
